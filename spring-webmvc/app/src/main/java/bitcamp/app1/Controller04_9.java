...
public class Controller04_9 {
  ...
  @ResponseBody
  public String handler1(@RequestParam(defaultValue = "홍길동") String name,
  ...
  @ResponseBody
  public String handler2(@RequestBody String jsondata) throws Exception {
